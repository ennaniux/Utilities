...
A lazy version is just to add
#+begin_example
#+title: THE_TITLE
#+author: YOUR_NAME @ UNIVERSITY
#+HTML_HEAD: <style>body {  max-width: 768px; margin: 20px auto; color:#003049 ;} </style>
#+options: toc:nil
...
** org notes / Beamer / slide 
This is a minimalistic set up that produces nice beamer slides.
#+begin_example
#+author: YOUR_NAME
#+title: THE_TITLE
#+startup: beamer
...
#+beamer_header: \institute[PUT \& ENS]{\includegraphics[width=4cm]{./LOGO.pdf} \\  University}
#+end_example
